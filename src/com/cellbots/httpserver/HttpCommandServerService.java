 ...
 * 
 */
public class HttpCommandServerService extends Service implements
	...
	public void onCreate() {
		super.onCreate();
		httpServer = new HttpCommandServer(ROOT,
				HttpCommandServerServiceManager.PORT, this);
	}
	...
	public IBinder onBind(Intent intent) {
		if (IHttpCommandServerService.class.getName()
	...
	private final IHttpCommandServerService.Stub serviceBinder = new IHttpCommandServerService.Stub() {
		@Override
		public void setResponseDataByName(String name, byte[] data,
				String contentType) {
			httpServer.addResponseByName(name, data, contentType);
		}

		@Override
		public void setResponsePathByName(String name, String resource,
				String contentType) {
	 ...
	 */
	private final IRegisterCallbackService.Stub registerCallbackBinder = new IRegisterCallbackService.Stub() {
