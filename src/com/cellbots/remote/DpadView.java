...
public class DpadView extends UiView {
	...
	public DpadView(Context context, final UiEventListener eventListener,
		...
		// DPAD buttons
		FrameLayout dpadControls = (FrameLayout) inflate.inflate(
				R.layout.remote_dpad, null);
		...
		getLocation.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				uiEventListener.onActionRequested(
						UiEventListener.ACTION_GET_LOCATION, "");
			}
		});
		...
		previousControl
				.setImageResource(R.drawable.brain_small);
