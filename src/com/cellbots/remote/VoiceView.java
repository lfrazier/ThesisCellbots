...
public class VoiceView extends UiView {
	...
	public VoiceView(final Context context, UiEventListener uiEventListener,
		...
		slidingDrawer.setOnDrawerOpenListener(new OnDrawerOpenListener() {
			public void onDrawerOpened() {
				...
				slidingDrawerButton.setContentDescription(context
	...
	private void loadGrammarAsync() {
		...
		String[] forward = context.getResources().getStringArray(
				R.array.voice_cmd_forward);
		String[] backward = context.getResources().getStringArray(
				R.array.voice_cmd_backward);
		String[] left = context.getResources().getStringArray(
				R.array.voice_cmd_left);
		String[] right = context.getResources().getStringArray(
				R.array.voice_cmd_right);
		String[] picture = context.getResources().getStringArray(
				R.array.voice_cmd_picture);
		String[] location = context.getResources().getStringArray(
				R.array.voice_cmd_location);
		String[] speak = context.getResources().getStringArray(
				R.array.voice_cmd_speak);
		String[] stop = context.getResources().getStringArray(
				R.array.voice_cmd_stop);
	...
	private final void onCommandRecognized(TreeSet<GrammarResult> results) {
		...
		// String toast = context.getString(R.string.voice_debug,
		// bestResult.getLiteral(),
		...
		mResult.setText(context.getString(R.string.voice_recognized, literal,
				meaning));
	...
	private void parseCommand(StringTokenizer toke) {
		...
		if (CMD_FORWARD.equals(command)) {
			...
			mListener.onActionRequested(UiEventListener.ACTION_TAKE_PICTURE,
					null);
		} else if (CMD_LOCATION.equals(command)) {
			mListener.onActionRequested(UiEventListener.ACTION_GET_LOCATION,
					null);
	...
	private void displayHelp() {
		new AlertDialog.Builder(getContext())
				...
				.setMessage(R.string.voice_help_message).setCancelable(true)
	 ...
	 */
	private final GrammarRecognizer.GrammarListener recoListener = new GrammarRecognizer.GrammarListener() {
		@Override
