...
public class UiView extends FrameLayout {
	public interface UiEventListener {
		...
		public static final int INTERFACE_WAVE = 4;
		...
		public static final int ACTION_CHANGE_PERSONA = 8; // Required value:
															// text for
															// expression
		 ...
		 * to be open sourced.
		 * 
		 * @see https://docs.google.com/a/google.com/document/d/1
		 *      Kl11k3YO9BsmoRIY4JEjZZoZX0BdYy_3AHC1GyVNuQQ/edit#
		 * @param action
		 *            An ACTION_XXX value
		 * @param values
		 *            Value to pass along to the action.
		 */
		 ...
		 * 
		 * @param direction
		 *            valid values are -180 to +180 where: -180 to 0 means left
		 *            0 to +180 means right
		 * @param speed
		 *            valid values are 0-100 which is a percentage of the robots
		 *            speed.
		 */
		 ...
		 * 
		 * @param interfaceId
		 *            The ID of the interface to switch to.
		 */
