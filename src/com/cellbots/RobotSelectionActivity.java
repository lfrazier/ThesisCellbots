...
public class RobotSelectionActivity extends ListActivity {
	...
	private enum SelectionIntents {
		INTENT_CREATE, INTENT_DIRECT_CREATE, INTENT_DIRECT_EDIT, INTENT_BRAIN_CREATE, INTENT_BRAIN_EDIT, INTENT_WEB_CREATE, INTENT_WEB_EDIT, INTENT_BLUECHECK_CREATE, INTENT_BLUECHECK_DIRECT_CONTROL, INTENT_BLUECHECK_DIRECT_EDIT, INTENT_BLUECHECK_BRAIN_CONTROL, INTENT_BLUECHECK_BRAIN_EDIT, INTENT_BLUECHECK_BRAIN_CREATE;
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mGlobalPrefs = PreferenceManager
		...
		addButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivityForResult(i,
						SelectionIntents.INTENT_CREATE.ordinal());
			}
		});
		...
		if (extras != null) {
			boolean mCreateNow = extras.getBoolean(
					RobotSelectionActivity.EXTRA_CREATE_NOW, false);
			if (mCreateNow) {
				Intent i = new Intent();
				i.setClass(self, com.cellbots.RobotCreationActivity.class);
				startActivityForResult(i,
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case INTENT_WEB_EDIT:
			...
			case RESULT_START_WEB_CREATE:
				i.setClass(mActivity,
						com.cellbots.RobotCreateWebRemoteActivity.class);
				i.putExtra(RobotSelectionActivity.EXTRA_EDIT, false);
				startActivityForResult(i,
						SelectionIntents.INTENT_WEB_CREATE.ordinal());
				break;
			default:
				Log.e(TAG, "Unexpected result: " + requestCode + "."
						+ resultCode);
			}
			break;
		case INTENT_BLUECHECK_CREATE:
			...
			case CheckBluetoothEnabledActivity.RESULT_SUCCESS:
				...
				i.putExtra(RobotSelectionActivity.EXTRA_EDIT, false);
				startActivityForResult(i,
						SelectionIntents.INTENT_DIRECT_CREATE.ordinal());
				break;
		...
		case INTENT_BLUECHECK_DIRECT_EDIT:
			...
			case CheckBluetoothEnabledActivity.RESULT_SUCCESS:
				...
				i.putExtra(RobotSelectionActivity.EXTRA_NAME, mExtraName);
				startActivityForResult(i,
						SelectionIntents.INTENT_DIRECT_EDIT.ordinal());
				break;
			case CheckBluetoothEnabledActivity.RESULT_WEB_ONLY:
				break;
			default:
		...
		case INTENT_BLUECHECK_DIRECT_CONTROL:
			...
			case CheckBluetoothEnabledActivity.RESULT_SUCCESS:
				i.setClass(mActivity,
						com.cellbots.directcontrol.CellDroidActivity.class);
		...
		case INTENT_BLUECHECK_BRAIN_CONTROL:
			...
			case CheckBluetoothEnabledActivity.RESULT_SUCCESS:
				i.setClass(mActivity,
						com.cellbots.local.CellDroidActivity.class);
				i.putExtra(EXTRA_NAME, mExtraName);
				startActivity(i);
				break;
			case CheckBluetoothEnabledActivity.RESULT_WEB_ONLY:
		...
		case INTENT_BLUECHECK_BRAIN_CREATE:
			...
			case CheckBluetoothEnabledActivity.RESULT_SUCCESS:
				...
				startActivityForResult(i,
						SelectionIntents.INTENT_BRAIN_CREATE.ordinal());
				break;
			case CheckBluetoothEnabledActivity.RESULT_WEB_ONLY:
				break;
			default:
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, PREFS_ID, 0, R.string.settings).setIcon(
				android.R.drawable.ic_menu_preferences);
		menu.add(0, PREFS_ID + 1, 0, R.string.about_menu).setIcon(
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case PREFS_ID:
			...
			break;
		case (PREFS_ID + 1):
			new AlertDialog.Builder(RobotSelectionActivity.this)
	...
	private void refreshRobotList() {
		mPrefs = getSharedPreferences(LauncherActivity.PREFERENCES_NAME,
				MODE_PRIVATE);
		...
		if (mRobotProfiles.size() > 0) {
			noCellbotsMsgView.setLayoutParams(new LinearLayout.LayoutParams(
	...
	private void showLongPressOptionsPopup(final int botIndex) {
		...
		// long-pressed.
		String[] qrOptions = { "Show QR Code", "Edit", "Delete" };

		String[] directOptions = { "Share", "Edit", "Delete" };
		...
		optionsPopupDialog.setItems(options,
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							case DIRECT_CONTROL:
								...
								i.setClass(
										self,
										com.cellbots.CheckBluetoothEnabledActivity.class);
								i.putExtra(
										RobotSelectionActivity.EXTRA_SHOW_WEBONLY_BUTTON,
										false);
								startActivityForResult(
										i,
										SelectionIntents.INTENT_BLUECHECK_BRAIN_CREATE
												.ordinal());
								break;
							case BRAIN:
							case WEB_CONTROL:
								...
								generateQrUri(RobotSelectionActivity.this,
										RobotEntry.newRemoteRobotEntry(
												selectedBot.getName(),
												selectedBot.getGmail(),
												selectedBot.getUrl(),
												selectedBot.getAgentId()));
								break;
							default:
								Log.d(TAG, "Unexpected share/usage: "
										+ selectedBot.getName() + "("
										+ selectedUsage + ")");
							}
							break;
						case 1:
							...
							case DIRECT_CONTROL:
								...
								startActivityForResult(
										i,
										SelectionIntents.INTENT_BLUECHECK_DIRECT_EDIT
												.ordinal());
								break;
							case BRAIN:
								mExtraName = selectedBot.getName();
								...
								startActivityForResult(
										i,
										SelectionIntents.INTENT_BLUECHECK_BRAIN_EDIT
												.ordinal());
								break;
							case WEB_CONTROL:
								i.setClass(
										self,
										com.cellbots.RobotCreateWebRemoteActivity.class);
								i.putExtra(RobotSelectionActivity.EXTRA_EDIT,
										true);
								i.putExtra(RobotSelectionActivity.EXTRA_NAME,
										selectedBot.getName());
								startActivityForResult(i,
										SelectionIntents.INTENT_WEB_EDIT
												.ordinal());
								break;
							default:
								Log.d(TAG, "Unexpected edit/usage: "
										+ selectedBot.getName() + "("
										+ selectedUsage + ")");
							}
							break;
	...
	public void deleteEntryPopup(final int entryIndex) {
		...
		deleteDialog.setPositiveButton("Delete it",
				new DialogInterface.OnClickListener() {
					@Override
		...
		deleteDialog.setNegativeButton("Leave it",
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
					}
	...
	public void refreshList() {
		...
		setListAdapter(new SimpleAdapter(this, list,
				R.layout.robot_selection_list_row, new String[] { "line1",
						"line2", "front" }, new int[] { R.id.text1, R.id.text2,
						R.id.icon1 }));
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case DIRECT_CONTROL:
					...
					i.putExtra(
							...
							false);
					startActivityForResult(i,
							SelectionIntents.INTENT_BLUECHECK_DIRECT_CONTROL
									.ordinal());
					break;
				case BRAIN:
					mExtraName = entry.getName();
					...
					i.putExtra(
							...
							false);
					startActivityForResult(i,
							SelectionIntents.INTENT_BLUECHECK_BRAIN_CONTROL
									.ordinal());
					break;
				case WEB_CONTROL:
					i.setClass(self,
							com.cellbots.remote.CellbotRCActivity.class);
	...
	public static void generateQrUri(Context ct, RobotEntry entry) {
		...
		webView.loadData(
				ct.getResources().getString(R.string.show_qr_text)
						+ "<br><img src='"
						+ "http://chart.apis.google.com/chart?chs=250x250&cht=qr&choe=UTF-8&chl="
						+ URLEncoder.encode(entry.serializeForUsage())
						+ "'></img>", "text/html", "UTF-8");
	...
	/**
	 * Get the shared preferences so that others can determine global
	 * preferences even if they don't have a context or view. To avoid memory
	 * leaks, callers should not store the value.
	 * 
