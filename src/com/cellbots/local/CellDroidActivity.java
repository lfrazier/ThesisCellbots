...
public class CellDroidActivity extends Activity implements CellDroidListener {
	...
	private TextView mRobotIdTextView, mTypeTextView, mBtTextView,
			mGmailTextView, mUrlTextView;
	...
	private Runnable bluetoothFailDialogRunnable = new Runnable() {
		...
		public void run() {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(
					CellDroidActivity.this);
			builder.setTitle("Bluetooth Failure");
			builder.setMessage(getResources().getString(
					R.string.bt_connection_fail_msg));
	...
	private HttpRequestListener httpRequestListener = new HttpRequestListener() {
		...
		public void onRequest(String req, String[] keys, String[] values,
			...
			if (req.equals("image.jpg"))
				...
				if (!processCommand(message)
						&& !celldroid.processCommand(message)) {
		...
		public void onConnected() {
			localHttpManager.setResponseByName("command.php", "s".getBytes(),
					"text/text");
		}
	};
	...
	public void onCreate(Bundle icicle) {
		...
		connectButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				celldroid.connect(mEntry.getAgentId(), mEntry.getGmail(),
						mEntry.getPasswd(), mEntry.getUrl(),
						mEntry.getUseLocalHttpServer());

				celldroid.setController(mEntry.getType(),
						mEntry.getBluetoothName(), mEntry.getBluetoothAddr());
			}
		});
		...
		displayQrButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				RobotSelectionActivity.generateQrUri(
						CellDroidActivity.this,
						RobotEntry.newRemoteRobotEntry(mEntry.getName(),
								mEntry.getGmail(), mEntry.getUrl(),
								mEntry.getAgentId()));
			}
		});
	}
		...
		if (message.equals("persona on")) {
			CellDroidActivity.this.runOnUiThread(new Runnable() {
				...
				public void run() {
					if (mEyesView != null)
						mEyesView.hide();
					mEyesView = new EyesView(CellDroidActivity.this, null,
							false);
				}
			});
			return true;
			...
			CellDroidActivity.this.runOnUiThread(new Runnable() {
				...
				public void run() {
					if (mEyesView != null)
						mEyesView.hide();
					mEyesView = new EyesView(CellDroidActivity.this,
							mRemoteEyesUrl, false);
				}
			});
			return true;
