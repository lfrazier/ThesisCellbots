...
public class XmppCommChannel extends AbstractCommChannel {
	...
	public XmppCommChannel(String username, String password,
			String targetUsername, CommMessageListener listener, String name) {
		super(name);
		...
		mConnection.addPacketListener(new PacketListener() {
			public void processPacket(Packet packet) {
				...
				if (message.getBody() != null && mMessageListener != null) {
					mMessageListener.onMessage(new CommMessage(message
							.getBody(), null, "text/text", message.getFrom(),
							message.getTo(), mChannelName,
							CommunicationManager.CHANNEL_XMPP));
				}
			}
		}, filter);
