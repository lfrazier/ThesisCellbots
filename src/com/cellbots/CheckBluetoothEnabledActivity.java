...
/**
 * Determine whether Bluetooth is enabled or not. If it is not enabled, ask the
 * user whether they want it enabled. This activity returns a result indicating
 * success or user intent (intention cancel vs. intention cloud only).
 * 
...
public class CheckBluetoothEnabledActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			mShowWebControl = extras.getBoolean(
					RobotSelectionActivity.EXTRA_SHOW_WEBONLY_BUTTON, true);
		}
	...
	/**
	 * Check whether Bluetooth is enabled or not. Can be called from anyone,
	 * anywhere.
	 * 
